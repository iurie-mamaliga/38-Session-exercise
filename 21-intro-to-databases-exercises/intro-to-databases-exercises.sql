...
SELECT name, continent, continent, gnp 
FROM country
WHERE   gnp > 1000000
;
...
FROM country 
WHERE governmentform LIKE '%onarch%'
;
...
SELECT (gnp/ population)*1000000 as precapitagnp
FROM country
WHERE continent = 'Europe'
;
...
SELECT (2018 - indepyear) as numberofyearssinceindep
FROM country
